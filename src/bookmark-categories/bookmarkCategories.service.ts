...
export class BookmarkCategoriesService {
  ...
  async findAll(bookmarkCategoryQueryDto: FindBookmarkCategoryDto) {
    return await this.bookmarkCategoryRepository.findAll(
      bookmarkCategoryQueryDto,
    );
  }

  async create(
    bookmarkCategoryDto: CreateBookmarkCategoryDto,
  ...
  async updateBookmarkCategory(
    id: number,
    updateBookmarkCategoryDto: UpdateBookmarkCategoryDto,
  ): Promise<BookmarkCategory> {
    return await this.bookmarkCategoryRepository.updateBookmarkCategory(
      id,
